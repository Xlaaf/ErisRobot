...
from KaiRoboto.modules import ALL_MODULES
from KaiRoboto.modules.helper_funcs.chat_status import is_user_admin
from KaiRoboto.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KaiRoboto.modules." + module_name)
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Rudeus sama?!")
        except Unauthorized:
            LOGGER.warning(
